class GoodsModel {
  ...
  GoodsModel({this.code, this.message, this.data});

  GoodsModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    message = json['message'];
    data = json['data'] != null ? new Goods.fromJson(json['data']) : null;
  }
...
class Goods {
  ...
  Goods({this.goodInfo, this.goodComments, this.advertesPicture});
