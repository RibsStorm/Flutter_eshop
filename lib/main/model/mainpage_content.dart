class MainPageContentModel {
  String code;
  String message;
  MainPageContent data;

  MainPageContentModel({this.code, this.message, this.data});

  MainPageContentModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    message = json['message'];
    data = json['data'] != null
        ? new MainPageContent.fromJson(json['data'])
        : null;
  }
...
//  List<Null> reservationGoods;
  ...
  MainPageContent.fromJson(Map<String, dynamic> json) {
    if (json['slides'] != null) {
